...
const talks: Talk[] = [
  ...
  {
    speaker: `Christian`,
    title: `Amateur's Branding Exercise`,
    start: `3:50`,
    end: `4:00`,
    event: 0,
    scheduled: true,
  ...
  {
    speaker: `Felipe`,
    title: `Something New In Laravel Validation`,
    start: `4:00`,
    end: `4:10`,
    event: 0,
    scheduled: true,
  ...
  {
    speaker: `Colin`,
    title: `Unit Testing Middleware in Laravel`,
    start: `4:15`,
    end: `4:20`,
    event: 0,
    scheduled: true,
  },
  {
    ...
    title: `Ionic-React Growth Sessions Mobile App `,
    start: `4:20`,
    end: `4:30`,
    event: 0,
    scheduled: true,
